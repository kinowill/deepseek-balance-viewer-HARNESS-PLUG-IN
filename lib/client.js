...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var css =
      ...
      ".dbb_stateWarn{color:var(--dsw-alias-state-warn-label)}" +
    ...
    var dicts = {
      fr: {
        ...
        unavailable: "Crédit API indisponible",
      ...
      en: {
        ...
        unavailable: "API credit unavailable",
    ...
    function ledColorOf(state) {
      ...
      if (state === "missing-key" || state === "unavailable") return "var(--dsw-alias-state-warn-label)";
    ...
    function BalanceBadge(props) {
      ...
      var hasBalance = snapshot.balance !== null && typeof snapshot.balance === "object";
      var label = hasBalance ? snapshot.balance.total + " " + snapshot.balance.currency : message;
              ...
              h(
                ...
                hasBalance
                  ? h(
                      ...
                      message !== null ? h("p", { className: "dbb_state dbb_stateWarn" }, message) : null,
                    )
                ...
                h(
                  ...
                  h(
                    ...
                    h(primitives.IconCheckOutlineRegular, { size: 14 }),
                    t("keySave"),
                  ),
